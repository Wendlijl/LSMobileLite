...
public class EnemyObject
{
    ...
    public string enemyString; //variable to hold the keyword for the tile

    [SerializeField] //I'm not actually sure what this does. Look it up.
    public EnemyObject(int newX, int newY, string newEnemyString) //This method assigns the given inputs to the variable that were created to hold them
    {
        xCoordinate = newX;
        yCoordinate = newY;
        enemyString = newEnemyString;
    }
